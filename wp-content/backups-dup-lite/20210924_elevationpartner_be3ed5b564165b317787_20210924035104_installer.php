...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210924_elevationpartner_be3ed5b564165b317787_20210924035104_archive.zip';
	const ARCHIVE_SIZE		 = '512402399';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'be3ed5b-24035104';
    const SECONDARY_PACKAGE_HASH = '31a97ca-24035104';
	const VERSION			 = '1.4.3';
