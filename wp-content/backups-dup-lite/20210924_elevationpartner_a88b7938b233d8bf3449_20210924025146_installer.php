...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210924_elevationpartner_a88b7938b233d8bf3449_20210924025146_archive.zip';
	const ARCHIVE_SIZE		 = '190163093';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a88b793-24025146';
    const SECONDARY_PACKAGE_HASH = '60b50b8-24025146';
	const VERSION			 = '1.4.3';
