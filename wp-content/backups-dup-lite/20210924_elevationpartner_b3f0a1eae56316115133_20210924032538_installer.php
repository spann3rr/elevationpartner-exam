...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210924_elevationpartner_b3f0a1eae56316115133_20210924032538_archive.zip';
	const ARCHIVE_SIZE		 = '259941645';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b3f0a1e-24032538';
    const SECONDARY_PACKAGE_HASH = '8c514a0-24032538';
	const VERSION			 = '1.4.3';
