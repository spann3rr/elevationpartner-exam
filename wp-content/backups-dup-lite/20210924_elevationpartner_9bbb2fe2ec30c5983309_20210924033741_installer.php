...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210924_elevationpartner_9bbb2fe2ec30c5983309_20210924033741_archive.zip';
	const ARCHIVE_SIZE		 = '386096676';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9bbb2fe-24033741';
    const SECONDARY_PACKAGE_HASH = 'b253270-24033741';
	const VERSION			 = '1.4.3';
